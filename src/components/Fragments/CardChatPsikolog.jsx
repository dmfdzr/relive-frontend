...
const CardChatPsikolog = () => {
    return (
        <Link to="/detail-chat-psikolog">
          <div className="w-max-screen my-4 mx-auto bg-cyan-700 text-white rounded-lg p-5 flex items-center cursor-pointer hover:bg-cyan-600 transition duration-200">
            ...
            <div className="flex-grow">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-base md:text-lg lg:text-xl font-semibold">P. Yosianudin</h3>
...
export default CardChatPsikolog
