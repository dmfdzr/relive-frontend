  ...
  return (
    <div id="artikel">
      <div className="relative w-full max-h-full text-slate-600 mb-[42rem]">
        <div
          className="relative w-full h-[40rem] bg-cover bg-center p-16 object-cover"
          style={{ backgroundImage: "url('/images/artikel1.jpg')" }}
        >
...
export default ArtikelLayouts1;
